...
describe Hubspot do
  ...
  describe Hubspot::Blog do
    ...
    describe '.find_by_id' do
      ...
      it 'should have a list of blogs' do
        blog = Hubspot::Blog.find_by_id(351_076_997)
        blog['id'].should eq(351_076_997)
      end
    end
  ...
  describe Hubspot::BlogPost do
    ...
    it 'can find by blog_post_id' do
      blog = Hubspot::BlogPost.find_by_blog_post_id(422_192_866)
      expect(blog['id']).to eq(422_192_866)
    end

    context 'containing a topic' do
      # 422192866 contains a topic
      let(:blog_with_topic) { Hubspot::BlogPost.find_by_blog_post_id(422_192_866) }
