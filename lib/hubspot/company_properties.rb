module Hubspot
  class CompanyProperties < Properties
    ALL_PROPERTIES_PATH  = '/companies/v2/properties'.freeze
    ALL_GROUPS_PATH      = '/companies/v2/groups'.freeze
    CREATE_PROPERTY_PATH = '/companies/v2/properties/'.freeze
    UPDATE_PROPERTY_PATH = '/companies/v2/properties/named/:property_name'.freeze
    DELETE_PROPERTY_PATH = '/companies/v2/properties/named/:property_name'.freeze
    CREATE_GROUP_PATH    = '/companies/v2/groups/'.freeze
    UPDATE_GROUP_PATH    = '/companies/v2/groups/named/:group_name'.freeze
    DELETE_GROUP_PATH    = '/companies/v2/groups/named/:group_name'.freeze
