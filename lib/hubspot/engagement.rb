...
module Hubspot
  ...
  class Engagement
    ...
    ENGAGEMENT_PATH = '/engagements/v1/engagements/:engagement_id'.freeze
    GET_ASSOCIATED_ENGAGEMENTS = '/engagements/v1/engagements/associated/:objectType/:objectId/paged'.freeze
