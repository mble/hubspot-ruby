module Hubspot
  ...
  #
  class Blog
    BLOG_LIST_PATH = '/content/api/v2/blogs'.freeze
    BLOG_POSTS_PATH = '/content/api/v2/blog-posts'.freeze
    GET_BLOG_BY_ID_PATH = '/content/api/v2/blogs/:blog_id'.freeze
    ...
    def posts(params = {})
      ...
      raise Hubspot::InvalidParams, 'params must be passed as a hash' unless params.is_a?(Hash)
      params = default_params.merge(params)

      raise Hubspot::InvalidParams, 'State parameter was invalid' unless [false, 'PUBLISHED', 'DRAFT'].include?(params[:state])
  ...
  class BlogPost
    GET_BLOG_POST_BY_ID_PATH = '/content/api/v2/blog-posts/:blog_post_id'.freeze
