module Hubspot
  ...
  class Contact
    CREATE_CONTACT_PATH          = '/contacts/v1/contact'.freeze
    BATCH_CREATE_OR_UPDATE_PATH  = '/contacts/v1/contact/batch/'.freeze
    GET_CONTACT_BY_EMAIL_PATH    = '/contacts/v1/contact/email/:contact_email/profile'.freeze
    GET_CONTACTS_BY_EMAIL_PATH   = '/contacts/v1/contact/emails/batch'.freeze
    GET_CONTACT_BY_ID_PATH       = '/contacts/v1/contact/vid/:contact_id/profile'.freeze
    CONTACT_BATCH_PATH           = '/contacts/v1/contact/vids/batch'.freeze
    GET_CONTACT_BY_UTK_PATH      = '/contacts/v1/contact/utk/:contact_utk/profile'.freeze
    GET_CONTACTS_BY_UTK_PATH     = '/contacts/v1/contact/utks/batch'.freeze
    UPDATE_CONTACT_PATH          = '/contacts/v1/contact/vid/:contact_id/profile'.freeze
    DESTROY_CONTACT_PATH         = '/contacts/v1/contact/vid/:contact_id'.freeze
    CONTACTS_PATH                = '/contacts/v1/lists/all/contacts/all'.freeze
    RECENT_CONTACTS_PATH         = '/contacts/v1/lists/recently_updated/contacts/recent'.freeze
    CREATE_OR_UPDATE_PATH        = '/contacts/v1/contact/createOrUpdate/email/:contact_email'.freeze
    QUERY_PATH                   = '/contacts/v1/search/query'.freeze
    ...
    class << self
      ...
      def create_or_update!(contacts)
        query = contacts.map do |ch|
          ...
          if contact_hash[:vid]
            contact_param[:vid] = contact_hash[:vid]
          elsif contact_hash[:email]
            contact_param[:email] = contact_hash[:email]
          else
