module Hubspot
  ...
  class Form
    ...
    FORM_PATH        = '/forms/v2/forms/:form_guid'.freeze # '/contacts/v1/forms/:form_guid'
    FIELDS_PATH      = '/forms/v2/fields/:form_guid'.freeze # '/contacts/v1/fields/:form_guid'
    FIELD_PATH       = FIELDS_PATH + '/:field_name'
    SUBMIT_DATA_PATH = '/uploads/form/v2/:portal_id/:form_guid'.freeze
