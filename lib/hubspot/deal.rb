...
module Hubspot
  ...
  #
  class Deal
    CREATE_DEAL_PATH = '/deals/v1/deal'.freeze
    DEAL_PATH = '/deals/v1/deal/:deal_id'.freeze
    RECENT_UPDATED_PATH = '/deals/v1/deal/recent/modified'.freeze
    UPDATE_DEAL_PATH = '/deals/v1/deal/:deal_id'.freeze
    ASSOCIATE_DEAL_PATH = '/deals/v1/deal/:deal_id/associations/:OBJECTTYPE?id=:objectId'.freeze
