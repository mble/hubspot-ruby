module Hubspot
  class DealProperties < Properties
    ALL_PROPERTIES_PATH  = '/deals/v1/properties'.freeze
    ALL_GROUPS_PATH      = '/deals/v1/groups'.freeze
    CREATE_PROPERTY_PATH = '/deals/v1/properties/'.freeze
    UPDATE_PROPERTY_PATH = '/deals/v1/properties/named/:property_name'.freeze
    DELETE_PROPERTY_PATH = '/deals/v1/properties/named/:property_name'.freeze
    CREATE_GROUP_PATH    = '/deals/v1/groups/'.freeze
    UPDATE_GROUP_PATH    = '/deals/v1/groups/named/:group_name'.freeze
    DELETE_GROUP_PATH    = '/deals/v1/groups/named/:group_name'.freeze
