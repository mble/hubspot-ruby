module Hubspot
  ...
  #
  class Company
    CREATE_COMPANY_PATH               = '/companies/v2/companies/'.freeze
    RECENTLY_CREATED_COMPANIES_PATH   = '/companies/v2/companies/recent/created'.freeze
    RECENTLY_MODIFIED_COMPANIES_PATH  = '/companies/v2/companies/recent/modified'.freeze
    GET_COMPANY_BY_ID_PATH            = '/companies/v2/companies/:company_id'.freeze
    GET_COMPANY_BY_DOMAIN_PATH        = '/companies/v2/companies/domain/:domain'.freeze
    UPDATE_COMPANY_PATH               = '/companies/v2/companies/:company_id'.freeze
    ADD_CONTACT_TO_COMPANY_PATH       = '/companies/v2/companies/:company_id/contacts/:vid'.freeze
    DESTROY_COMPANY_PATH              = '/companies/v2/companies/:company_id'.freeze
    GET_COMPANY_CONTACTS_PATH         = '/companies/v2/companies/:company_id/contacts'.freeze
